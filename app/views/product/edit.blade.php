...
@section('content')
    ...
    <form action="{{ route('edit-product-post/'.$product->id) }}" method="POST">
        ...
        <p style="font-size: 16px;">Tên sản phẩm</p>  <input type="text" name="ten_sp" value="{{$product->ten_sp}}"></br>
        <p style="font-size: 16px;"> Đơn giá</p> <input type="text" name="don_gia" value="{{$product->gia}}"></br>
